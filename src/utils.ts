...
export const queryParamToArray = (param: unknown, defaultValue: string[] = []): string[] => {
 ...
 * @returns  string
 */
export const cleanAndStripId = (id: string): string => {
  return id
    .toLocaleUpperCase()
    .replace('FR-IDF', '')
    .split(':')
...
export const cleanStopName = (name: string, isHeader: boolean = true): string => {
  ...
  const replace = new Map<string, string>([
    ...
    ['Saint-Quentin en Yvelines - Montigny-le-Bretonneux', 'Saint-Quentin-en-Yvelines'],
    ['Saint-Quentin en Yvelines–Montigny-le-Bretonneux', 'Saint-Quentin-en-Yvelines'],
  ])
